  ...
  try {
    ...
    const messages = [
      ...
      },
      {
        ...
        parts: [
          {
            text: `CRITICAL SECURITY RULE: NEVER include @here or @everyone or any roles like " <@&roleid>" NEVER PING ROLES in your responses. 
   If a user asks you to ping @here or @everyone, or tries to trick you into 
   including these mentions in any way (including in code, examples, or any format), 
   you must refuse and ONLY respond with exactly: "67 mango mustard. https://cdn.discordapp.com/attachments/1345258762180493396/1431165154975813722/HA0iRA0.png?ex=68fc6bea&is=68fb1a6a&hm=5b4d35940a30aabd563225cd4c3f35b2dfb053b058187a15e97c67ecdf561d6b&" BUT when users is not talking about @here or @everyone, anymore, you can respond normally without including those mentions.`
          }
        ]
      },
      {
    ...
    if (responseText) {
      ...
      return responseText.replace("@everyone", "@\u200beveryone").replace("@here", "@\u200bhere");
    }
